package facilities.samir.andrew.facilities.FCM;
...
import facilities.samir.andrew.facilities.activities.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
   ...
   /*     if (message.getNotification() != null) {
    ...
    private void sendNotification(NotificationData notificationData) {
        ...
        editor.putInt("notificationId", notificationData.getId());
        editor.apply();
        ...
        if (notificationData.getId() == 1) {
            ...
            editor.putString("notificationProject", notificationData.getProject());
            editor.putString("notificationUnit", notificationData.getUnit());
            editor.apply();
