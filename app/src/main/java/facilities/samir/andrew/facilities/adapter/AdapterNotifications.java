...
public class AdapterNotifications extends RecyclerView.Adapter<AdapterNotifications.MyViewHolder> {
    ...
    private List<NotificationModel> adapterList;
...
//            ((BaseActivity) activity).addContentFragment(UnitDetailsFragment.init(adapterList.get(getAdapterPosition())), true);
    ...
    public AdapterNotifications(List<NotificationModel> adapterList, Activity activity) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        NotificationModel NotificationModel = adapterList.get(position);

        holder.tvRvItemUnitName.setText(NotificationModel.getText());
    ...
    public void insertItem(NotificationModel item, int position) {
